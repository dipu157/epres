            ...
            <div class="card text-primary bg-gray border-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('prescription/general') }}" class="form-inner" method="post" accept-charset="utf-8">
                        ...
                        {{--<div class="form-group row">--}}
                            {{--<label for="complain" class="col-sm-2 col-form-label">Complain</label>--}}
                            {{--<div class="col-sm-10">--}}
                                {{--{!! Form::select('complain[]', $complains, null, ['multiple' => true, 'class' => 'form-control js-example-basic-multiple']) !!}--}}
                            {{--</div>--}}
                        {{--</div>--}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                {{--<input type="textarea" name="complains" value="{!! $prescription->complains !!}" class="form-control" id="complains">--}}
                            </div>
                        </div>
                        ...
                        {{--<div class="form-group row">--}}
                            ...
                            {{--<div class="col-sm-4">--}}
                                {{--<input type="text" name="stage" value="{!! $prescription->stage !!}" class="form-control" id="stage" placeholder="Stage" autofocus>--}}
                            {{--</div>--}}

                            {{--<label for="grade" class="col-sm-2 col-form-label">Grade</label>--}}
                            {{--<div class="col-sm-4">--}}
                                {{--<input type="text" name="grade" value="{!! $prescription->grade !!}" class="form-control" id="grade" placeholder="Grade">--}}
                            {{--</div>--}}
                        {{--</div>--}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                {{--<input type="text" name="diagnosis" value="{!! $prescription->diagnosis !!}" class="form-control" id="diagnosis" placeholder="Diagnosis">--}}
                            </div>
                        </div>
