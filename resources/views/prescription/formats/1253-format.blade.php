                            ...
                            <div class="container-fluid">
                                ...
                                <table class="table table-striped" id="report">
                                    ...
                                    <tr style="line-height: 60%; margin-top: 20px;">
                                        <td width="10%" style="font-size:12pt; color:black; "><strong>Date : {!! \Carbon\Carbon::parse($prescription->record_date)->format('d-M-Y')  !!}</strong></td>
                                        
                                        <!-- <td width="20%" style="font-size:12pt; color:black; "><strong>UHID : {!! $patient->registration_no !!}</strong></td> -->

                                        <td width="30%" style="font-size:12pt; color:black; "><strong>Name : {!! $patient->name !!}</strong></td>
                                    
                                        <td width="10%" style="font-size:12pt; color:black; "><strong>Age : {!! $patient->age !!}Y</strong></td>
                                    ...
                                    <tr style="line-height: 60%">
                                        ...
                                        <td width="20%" style="font-size:12pt; color:black; "><strong>BP : {!! $prescription->bp !!}</strong></td>

                                        <td width="10%" style="font-size:12pt; color:black; "><strong>Pulse : {!! $prescription->pulse !!}</strong></td>

                                        <td width="10%" style="font-size:12pt; color:black; "><strong>Weight : {!! $prescription->weight !!} </strong></td>

                                        <td width="10%" style="font-size:12pt; color:black; "><strong>BSA : {!! $prescription->bsa !!}</strong></td>

                                        <td width="20%" style="font-size:12pt; color:black; "><strong>Mobile : {!! $patient->mobile !!}</strong></td>
                                    </tr>
